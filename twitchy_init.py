...
# At this point, check your /dev/ directory for the location of the USB to Serial device; if in doubt,
# unplug the USB2Dynamixel, look at the /dev/ directory, then plug it back in and see which device has been added.

# For example, the upper right USB port on my computer gives the device: tty.usbserial-AI03QDFW,
# cat dewhile the the bottom left gives /dev/tty.usbserial-AI0282TZ
